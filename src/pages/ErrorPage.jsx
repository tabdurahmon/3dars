  ...
  if (error.status === 404) {
    return (
      <div className="text-centar pt-10 h-lvh">
        <h1 className="text-center mb-5 text-3xl font-bold">PageNotFound</h1>
        ...
        <div className="w-full text-center pt-5">
          <NavLink
            className="rounded-xl font-medium no-underline text-[#333] py-2 px-3 border-2 border-solid border-[#333] bg-white hover:bg-[#c26161] hover:text-white"
            to="/"
          >
            Home
          </NavLink>
